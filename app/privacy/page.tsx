    ...
    <>
      ...
      <div className="w-full space-y-6 py-6 xl:space-y-16">
        <div className="container space-y-2 p-12 md:p-40">
          <div className="prose prose-sm lg:prose-lg dark:prose-dark mx-auto">
            <div>
              <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                Privacy Policy
              </h1>
              <p className="pt-10">
                Your privacy is important to us. It is LinkChop's policy to respect your privacy
            ...
            <div className="pt-10">
              ...
              <p className="pt-4">
                When you visit our website, we may collect information about you in a few different
                ways. We collect both personal information and non-personal information.
              </p>
              <h4 className="scroll-m-20 pt-4 text-xl font-semibold tracking-tight">
                Personal information
              </h4>
              <p className="pt-4">
                We may ask you for personal information, such as your name, email address, and other
                contact details when you sign up for an account or fill out a form on our website.
              </p>
              <h4 className="scroll-m-20 pt-4 text-xl font-semibold tracking-tight">
                Non-personal information
              </h4>
              <p className="pt-4">
                We may also collect non-personal information about you when you visit our website,
                such as the type of browser you are using, the website you visited before you came
                to our website, the pages on our website that you visit, and the time spent on those
                pages.
              </p>
            </div>
            <div className="pt-10">
              ...
              <p className="pt-4">
                We may use the information we collect from you to personalize your experience and to
            ...
            <div className="pt-10">
              ...
              <p className="pt-4">
                ...
                implemented a variety of security measures to maintain the safety of your personal
            ...
            <div className="pt-10">
              ...
              <p className="pt-4">
                If you have any questions about our Privacy Policy, the practices of this site, or
                your dealings with this site, please contact us at support@linkchop.com.
              </p>
            </div>
          </div>
        </div>
