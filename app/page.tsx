      ...
      <div className="flex size-full pt-[72px] xl:space-y-16">
        <div className="flex size-full flex-col">
          <div className="flex size-full flex-col">
            <UrlMaker />
            <Separator />
            <section className="size-full py-12 md:py-24 lg:py-32" id="features">
            ...
            <Separator />
            <section className="size-full py-12 md:py-24 lg:py-32" id="prices">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                  <div className="space-y-2">
                    ...
                    <p className="mx-auto max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                      Choose the plan that&apos;s right for you. All plans come with unlimited links
                      and clicks.
                    </p>
                  </div>
                </div>
                <div className="mx-auto grid max-w-3xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
                  <Card className="h-full">
                    <CardContent className="p-0">
                      <div className="flex flex-col space-y-1.5 rounded-t-lg bg-gray-200 p-4 px-12 dark:bg-gray-600">
            ...
            <Separator />
            <section className="size-full py-12 md:py-24 lg:py-32 lg:pb-40" id="contact">
